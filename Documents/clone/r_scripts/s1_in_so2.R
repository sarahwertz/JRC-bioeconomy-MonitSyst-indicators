...
# - 2.1.b.4 - Share of organic farming in UAA  
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
organic_farming <- read.csv(paste0(cordir_in,"output_data/indicators/2.1.b.4/2.1.b.4.csv"), stringsAsFactors = FALSE)
organic_farming
...
# - 2.2.a.1 - Long term ratio of annual fellings to net annual increment 
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
NAI <- read.csv(paste0(cordir_in,"output_data/indicators/2.2.a.1/2.2.a.1.csv"), stringsAsFactors = FALSE) 
NAI
names(NAI)
...
# - 2.3.a.2 - Roundwood removals 
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
roundwood <- read.csv(paste0(cordir_in, "output_data/indicators/2.3.a.2/2.3.a.2.csv"), stringsAsFactors = FALSE) 
str(roundwood)
names(roundwood)
...
# - 2.2.d.5 - Intensification of farming (high, medium, low) 
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
intens_farming <- read.csv(paste0(cordir_in,"output_data/indicators/2.2.d.5/2.2.d.5.csv"), stringsAsFactors = FALSE)
intens_farming
